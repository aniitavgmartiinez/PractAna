...
export default function App() {
  ...
  return (
    <div style={{backgroundImage:`url(${Perro})`}} className='flex  justify-center items-center w-scren h-screen bg-contain bg-no-repeat object-contain'>
      <div className='divide-transparent flex justify-center items-center w-auto h-auto border border-pink-600 rounded-md shadow-md'>
      ...
      <p className='font-bold text-lg text-center bg-gradient-to-br from-lime-400 via-teal-300 to-pink-500 text-white p-2 border-transparent rounded-lg'>Bienvenido a<br/>LINA TOPSHINE</p>
        <p className='font-bold pb-4 pt-8 text-teal-700'>Nombre:</p>
